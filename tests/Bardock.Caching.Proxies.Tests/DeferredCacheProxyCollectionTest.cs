...
namespace Bardock.Caching.Proxies.Tests
{
    public class DeferredCacheProxyCollectionTest
    {
        ...
        public void GetData_DefaultExpiration()
        {
            ...
            var proxy = new DeferredCacheProxyCollection<int, DateTime>(cache.Object, KEY);

            var v1_1 = proxy.GetData(1, num => DateTime.Now);
            Thread.Sleep(50);
            var v2_1 = proxy.GetData(2, num => DateTime.Now);
            Thread.Sleep(50);
            var v1_2 = proxy.GetData(1, num => DateTime.Now);
        ...
        public void GetData_Clear()
        {
            ...
            proxy.Clear(1);
            Thread.Sleep(50);
            var v1_3 = proxy.GetData(1, num => DateTime.Now);
            var v2_2 = proxy.GetData(2, num => DateTime.Now);
        ...
        public void GetData_Params_String()
        {
            ...
            var proxy = new DeferredCacheProxyCollection<string, DateTime>(cache: cache.Object, keyPrefix: KEY);

            var v1 = proxy.GetData("1", num => DateTime.Now);
            Thread.Sleep(50);
            var v2 = proxy.GetData("1", num => DateTime.Now);
        ...
        public void GetData_Params_Null()
        {
            ...
            var v1 = proxy.GetData(null, num => DateTime.Now);
            Thread.Sleep(50);
            var v2 = proxy.GetData(null, num => DateTime.Now);
        ...
        public void GetData_Params_Complex()
        {
            ...
            var proxy = new DeferredCacheProxyCollection<Dictionary<string, object>, DateTime>(cache: cache.Object, keyPrefix: KEY);

            var v1 = proxy.GetData(new Dictionary<string, object> { { "asd", 1 } }, num => DateTime.Now);
            Thread.Sleep(50);
            var v2 = proxy.GetData(new Dictionary<string, object> { { "asd", 1 } }, num => DateTime.Now);
            Thread.Sleep(50);
            var v3 = proxy.GetData(new Dictionary<string, object> { { "asd", 2 } }, num => DateTime.Now);
